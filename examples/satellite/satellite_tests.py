...
def main():
    ...
    # title = "40% Failure Rate Without Power Loss"
    # plt.title( title )
    ...
    # bp_0 = ax.boxplot( new_iteration_count, positions=x - 1.1 * bar_width / 2, widths=bar_width, notch=True, patch_artist=True,
    ...
    #              )
    # bp_1 = ax.boxplot( old_iteration_count, positions=x + 1.1 * bar_width / 2, widths=bar_width, notch=True, patch_artist=True,
    ...
    # bp_0 = ax.boxplot( new_cpu_time, positions=x - 1.1 * bar_width / 2, widths=bar_width, notch=True,
    #                    patch_artist=True,
    #                    boxprops=dict( facecolor=c_0, color=c_0 ),
    #                    capprops=dict( color=c_0 ),
    #                    whiskerprops=dict( color=c_0 ),
    ...
    #                    medianprops=dict( color=c_2 ),
    #                    )
    # bp_1 = ax.boxplot( old_cpu_time, positions=x + 1.1 * bar_width / 2, widths=bar_width, notch=True,
    #                    patch_artist=True,
    #                    boxprops=dict( facecolor=c_1, color=c_1 ),
    #                    capprops=dict( color=c_1 ),
    #                    whiskerprops=dict( color=c_1 ),
    ...
    # bp_0 = ax.boxplot( new_action_count, positions=x - 1.1 * bar_width / 2, widths=bar_width, notch=True,
    #                    patch_artist=True,
    #                    boxprops=dict( facecolor=c_0, color=c_0 ),
    #                    capprops=dict( color=c_0 ),
    #                    whiskerprops=dict( color=c_0 ),
    ...
    #                    medianprops=dict( color=c_2 ),
    #                    )
    # bp_1 = ax.boxplot( old_action_count, positions=x + 1.1 * bar_width / 2, widths=bar_width, notch=True,
    #                    patch_artist=True,
    #                    boxprops=dict( facecolor=c_1, color=c_1 ),
    #                    capprops=dict( color=c_1 ),
    #                    whiskerprops=dict( color=c_1 ),
